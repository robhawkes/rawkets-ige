var IgeSatComponent = IgeClass.extend({
  classId: 'IgeSatComponent',
  componentId: 'sat',

  init: function (entity, options) {
    this._entity = entity;

    // Options are top-left x, top-left y, width, height
    this._sat = new SAT.Box(options.x, options.y, options.width, options.height);

    // Add the OOB behaviour to the entity
    entity.addBehaviour('sat', this._behaviour);
  },
...
if (typeof(module) !== 'undefined' && typeof(module.exports) !== 'undefined') { module.exports = IgeSatComponent; }
